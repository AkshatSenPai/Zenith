...
*PRD Version 2.3 | Updated: July 2026 (from v2.2 · v2.1 · v2.0 · v1.9 · v1.8 · v1.7 · v1.6 · v1.5 · v1.4 · v1.3 · v1.2 · v1.1 · v1.0, June 15, 2026)*
...
*Next Step: Milestone 7 — Proactivity + WhatsApp triage (v7 HUD + orb port shipped to main 2026-07-03; M6 fully shipped). Tauri desktop shell (`src-tauri/`) still pending from M2.*
