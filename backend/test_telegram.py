"""M4 Telegram tests: the security allow-list (fail-closed), the confirm-summary rendering, and the
chat_core refactor (per-channel memory, pending stores its channel). PTB/Claude are not called."""
